    ...
    <section className='sec01_e'>
            ...
            <div className='row column-rever_sm'>
                ...
                <div className='col-lg-6 col-md-6 alin_c text-center'>
                    ...
                    <p className='text '>Welcome to TomAX.We are committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect your personal information, including your name, email address, phone number, payment information, etc. We use this information to process transactions and to operate, maintain, personalize, and expand our site. We may share this information with our service providers and may disclose your information if required by law or in response to valid requests by public authorities. </p>
                    ...
                    <h4 className='sub_title bc'>Email:  <span className='wc'>@gmail.com</span></h4>
                </div>
                <div className='col-lg-6 col-md-6 alin_c text-center'>
