                ...
                <div className='col-lg-8'>
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link tab_btn active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Timex</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link tab_btn" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Cryptocurrency</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link tab_btn" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Buy Crypto</button>
                        </li>
                    </ul>
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="accordion-item">
                                    ...
                                    <div class="accordion-body">
                                        <p>To begin, visit our website and click on the ‘Register’ button. You’ll be directed to the registration page where you should fill in all required fields. Once you’ve completed the details, click ‘Register Now’ to submit your information.
                                            Next, you’ll need to complete the KYC (Know Your Customer) process. Have your proof of identity and address ready. To access the KYC verification page, either click ‘Verify Now’ in the login pop-up or navigate to your profile in the top right corner. Select ‘My Account’, then choose ‘KYC Verification’. Finally, click ‘Verify Your KYC’ to start the verification process.
                                            It’s that easy</p>
                                    </div>
                                    </div>
                                </div>
...
A QR code will be generated that you can either copy or scan using MetaMask, Coinbase, Trust Wallet, or any other preferred wallet. Simply paste or scan the code into your wallet, and you’re all set to start making transactions. Happy investing!</p>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div class="accordion-body">
                                        <p>You have two options: convert your existing currency into your chosen crypto or purchase directly. Keep in mind that limits may apply based on your payment method and location. Ready to get started?</p>
                                    </div>
                                    </div>
                                </div>
                        </div>
                        ...
                        <div class="accordion" id="accordionExample">
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingOne">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                How Do We Ensure the Safety of Your Funds and Personal Information?
                                </button>
                                </h2>
                                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <p>Your security is our top priority. We implement robust measures to protect your funds and personal data, including two-factor authentication, SSL encryption, and cold storage for your assets. These layers of protection ensure that your information and investments remain secure.</p>
                                </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingTwo">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                What’s the Typical Timeframe for Processing Deposits and Withdrawals?
                                </button>
                                </h2>
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <p>Deposits and withdrawals are generally processed quickly, often within a few minutes. However, the exact timing can vary depending on your payment method and the current network activity. </p>
                                </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingThree">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                Curious About the Cryptocurrencies Available for Trading?
                                </button>
                                </h2>
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <p>Our platform supports a wide range of cryptocurrencies, including Bitcoin, Ethereum, Litecoin, and many more. Explore our diverse selection to find the digital assets that fit your trading strategy.</p>
                                </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div class="accordion-body">
                                    <p>Getting started is easy—just sign up and follow our straightforward onboarding process. Dive in and begin your trading journey with confidence!</p>
                                </div>
                                </div>
                            </div>
                            </div>
