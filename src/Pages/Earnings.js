    ...
    <>
      ...
      <div className='container '>
            <div className='row'>
                ...
                <div className='col-lg-6 col-md-7 col-sm-7 alin_c'>
                    ...
                    <h2 className='title_h2 wc'>Invite a Friend and Claim 50 Hill Token </h2>
                    <p className='text '>Invite your friends to join Tomax and instantly receive 50 Hill Token credited to your account. Use these tokens to explore the platform, access exclusive features, and grow your crypto portfolio. Plus, you'll unlock even more rewards and perks that make Tomax the go-to destination for crypto enthusiasts.</p>
      ...
      <div className='container '>
            ...
            <div className='col-lg-6 col-md-7 col-sm-7 alin_c'>
                    ...
                    <h2 className='title_h2 wc'>Complete your KYC verification and receive 50 Hill Token as a token of our appreciation</h2>
