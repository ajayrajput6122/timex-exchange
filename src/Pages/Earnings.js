                    ...
                    <div className='row mt-5'>
                        <div className='col-lg-4'>
                            <div className='sec4_box'>
                                ...
                                <p className='sec4_box_text'>You can invite your friends to use Bitnetto products with just one referral code.</p>
                            </div>
                        </div>
                        <div className='col-lg-4'>
                            <div className='sec4_box'>
                        ...
                        <div className='col-lg-4'>
                            <div className='sec4_box'>
                                ...
                                <p className='sec4_box_text'>Automatically get Trading Commissions through Bitnetto Card Rewards.</p>
                            </div>
                        </div>
                    </div>
        </div>
