...
const Myprofile = () => {
  ...
  useEffect(() => {
    const tabButton = document.querySelector(
      `[data-bs-target="#v-pills-${activeTab}"]`
    );
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="tabs_d-flex align-items-start">
                <div
                  className="nav nav_tab_sid flex-column nav-pills"
                  id="v-pills-tab"
                  role="tablist"
                  aria-orientation="vertical"
                >
                  <button
                    className="nav-link p_tabs_btn active"
                    id="v-pills-home-tab"
                    data-bs-toggle="pill"
                ...
                >
                  <div
                    className="tab-pane fade wc show active"
                    id="v-pills-home"
                    role="tabpanel"
